...
class Dashboard extends StatefulWidget {
  ...
  final DocumentSnapshot snapshot;
  //final DocumentSnapshot snapshot;
  Dashboard({@required this.snapshot, this.PatientNameVar});
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: [Colors.lightBlue[100], Colors.lightBlue[100]]),
        ),
        child: Center(
                  ...
                  ? Column(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            CustomPaint(
                              foregroundPainter: CircleProgress(spO2, true),
                              child: Container(
                                width: 200,
                                height: 200,
                                child: Center(
                            ...
                            CustomPaint(
                              foregroundPainter: CircleProgress(bPM, true),
                              child: Container(
                                width: 200,
                                height: 200,
                                child: Center(
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            CustomPaint(
                              foregroundPainter: CircleProgress(bodyTemp, true),
                              child: Container(
                                width: 200,
                                height: 200,
                                child: Center(
                            ...
                            Container(
                              ...
                              child: SizedBox(
                                ...
                                child: RaisedButton(
                                  ...
                                  onPressed: () async {
                                    print("HELLO Artiel");
                                    http.Response tryText = await http
                                        .get('http://192.168.37.147:5000/');
                                    print("Hello Idea");
